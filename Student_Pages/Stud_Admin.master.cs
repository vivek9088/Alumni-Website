...
public partial class Student_Pages_Stud_Admin : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string urlnow = Path.GetFileName(Request.PhysicalPath).Substring(5, 1);
        switch (urlnow)
        {
            case "I":
            ...
            case "E":
            case "A":     
                stud.Attributes.Add("class", "current");
                break;
        ...
        else
        {
            ...
            catch (Exception ex)
            {
                ...
                errlog.ErrorLog(Server.MapPath("../Logs/Errorlog"), "Page Load of Student Admin Master Page for " + Session["loginname"] + ":" + ex.Message);
            }
            finally
            {
                con.Close();
    ...
    protected void vote_Click1(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            log.ErrorLog(Server.MapPath("Logs/Errorlog"), "vote method of Student_Admin master page for " + Session["loginname"] + ":" + ex.Message);
        }
    ...
    protected void pollresult(string quest)
    {
        ...
        {
            CreateLogFile log = new CreateLogFile();
            log.ErrorLog(Server.MapPath("Logs/Errorlog"), "Poll Result method of Student_Admin Master page for " + Session["loginname"] + ":" + ex.Message);
        }
        finally
        {
            con.Close();
